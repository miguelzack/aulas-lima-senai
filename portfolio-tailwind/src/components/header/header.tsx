    ...
    return (
        <header className="flex flex-row items-center justify-between w-full">
            ...
            <nav className="flex py-[15px] px-[90px] gap-[75px] items-center justify-center rounded-[35px] bg-white shadow-[0_4px_15px_0_rgba(0,0,0,0.10)]">
                <a href="#home" className="text-gray-custom hover:text-black-hover text-xl font-normal">Home</a>
                <a href="#portfolio" className="text-gray-custom hover:text-black-hover text-xl font-normal">Portfolio</a>
